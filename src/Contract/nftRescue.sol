...
contract NFTRescue is ERC721, Ownable {
    using Strings for uint256; 

    uint256 public constant MAX_TOKENS = 10000;
    uint private constant TOKEN_RESERVED = 0;
    ...
    constructor() ERC721("NFT Rescue", "NFTR") Ownable(msg.sender) {
        baseUri = "ipfs://bafybeigeex44qcvqf3tjaz2kgqzgoktw67izwkhrbah6sq5p5of2bthwk4/";
